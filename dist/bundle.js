...
getbutton.addEventListener("click", function () {
    var inputElement = document.getElementById("getInputId");
    if (inputElement.value === "" || inputElement.value === " " || inputElement.value === null) {
        getAll();
    }
    else {
        var ID = Number(inputElement.value);
        getWithId2(ID);
    }
});
function getWithId(ID) {
    var resultElement = document.getElementById("getIdResult");
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("http://democlassrestservice.azurewebsites.net/api/Items/" + ID)
...
function getAll() {
    var resultElement = document.getElementById("getIdResult");
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("http://democlassrestservice.azurewebsites.net/api/Items/")
        .then(function (response) {
        resultElement.innerHTML = JSON.stringify(response.data);
    })
        .catch(function (error) {
...
function post() {
    var postinputElement = document.getElementById("postInput");
    var postResult = document.getElementById("postResult");
    var itemInfo = postinputElement.value.split(";");
    var postItem = new Item(Number(itemInfo[0]), itemInfo[1], itemInfo[2], Number(itemInfo[3]));
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post("http://democlassrestservice.azurewebsites.net/api/Items", postItem)
        .then(function (response) {
...
var Item = /** @class */ (function () {
    function Item(id, name, quality, quantity) {
        this.id = id;
        this.name = name;
